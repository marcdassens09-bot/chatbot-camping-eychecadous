(function () {
  ...
  bubble.addEventListener("click", function () {
    ...
    if (!isOpen && iframe.contentWindow) {
      // Vide l'affichage à la fermeture, sans perdre le contexte de la
      // conversation (gardé côté serveur via le sessionId de l'iframe).
      iframe.contentWindow.postMessage("mpia-clear-display", CHATBOT_URL);
    }
